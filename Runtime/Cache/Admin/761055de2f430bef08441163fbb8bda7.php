...
<head>
    ...
    <link href="/yl/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/yl/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/yl/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/yl/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/yl/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/yl/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/yl/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/yl/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/yl/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
	...
	<script type="text/javascript" src="/yl/Public/static/uploadify/jquery.uploadify.min.js"></script>
...
<div class="tab-wrap">
                        ...
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/yl/Public/static/uploadify/uploadify.swf",
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/yl", //当前网站地址
            "APP"    : "/yl/admin.php?s=", //当前项目地址
            "PUBLIC" : "/yl/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/yl/Public/static/think.js"></script>
    <script type="text/javascript" src="/yl/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/yl/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/yl/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/yl/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/yl/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/yl/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
