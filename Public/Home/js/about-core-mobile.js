...
var firstInitImg = function(){
    ...
    $(".left2-mobile").css("top",img2Top);
    $(".right2-mobile").css("top",img2Top);
    var img3Top = (parseInt($(".left2-mobile").css("top")) + parseInt($(".left2-mobile").children("img").css("height")) * 0.98) + 'px';
    $(".left3-mobile").css("top",img3Top);
    $(".right3-mobile").css("top",img3Top);
